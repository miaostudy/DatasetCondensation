...
from utils import get_loops, get_dataset, get_dataset_med, get_network, get_eval_pool, evaluate_synset, get_daparam, match_loss, get_time, TensorDataset, epoch, DiffAugment, ParamDiffAug
...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='/data/users/xiongyuxuan/DD/OBJDD/DatasetCondensation-master/data', help='dataset path')
    ...
    log_name = args.method + '_IPC={}_Model_{}_Data_{}'.format(args.ipc,args.model,args.dataset)
        ...
        for it in range(args.Iteration+1):
            ...
            if it in eval_it_pool:
                for model_eval in model_eval_pool:
                    ...
                    logger.info(f'DSA augmentation strategy: \n{args.dsa_strategy}')
                    logger.info(f'DSA augmentation parameters: \n{args.dsa_param.__dict__}')
                    ...
                    for it_eval in range(args.num_eval):
                        ...
                        net, acc_train, acc_test, sensitivity, specificity, f1,cm = evaluate_synset(it_eval, net_eval, image_syn_eval, label_syn_eval, testloader, args)
            ...
            if 'BN' not in args.model: # for ConvNet
                ...
                for c in range(num_classes):
                    ...
                    if args.dsa:
                        ...
                        img_real = DiffAugment(img_real.double(), args.dsa_strategy, seed=seed, param=args.dsa_param)
                        img_syn = DiffAugment(img_syn.double(), args.dsa_strategy, seed=seed, param=args.dsa_param)
